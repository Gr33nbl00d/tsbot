/**
 * Eliza Author: Charles Hayden http://www.chayden.net/eliza/Eliza.html Modified by Andres Colubri to use it as a Processing library
 */
...
public class Eliza {
  ...
  public Eliza(ScriptDataLoader scriptDataLoader) {
    this.scriptDataLoader = scriptDataLoader;
  ...
  public boolean readDefaultScript() {
    ...
    return readScript("script.txt");
  }

  public boolean readScript(String script) {
    clearScript();

    String[] lines = scriptDataLoader.loadStrings(script);
