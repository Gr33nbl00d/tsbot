...
public class EString {
  ...
  /**
   * Look for a match between the string and the pattern. Return count of maching characters before * or #. Return -1 if strings do not
   * match.
   */
  ...
  /**
   * Search in successive positions of the string, looking for a match to the pattern. Return the string position in str of the match, or -1
   * for no match.
   */
  ...
  /**
   * Compresses its input by: dropping space before space, comma, and period; adding space before question, if char before is not a space;
   * and copying all others
   */
